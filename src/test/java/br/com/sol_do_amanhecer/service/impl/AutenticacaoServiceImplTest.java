...
public class AutenticacaoServiceImplTest {
    ...
    private Usuario criarUsuario(UUID uuid, String username, String senha, List<Permissao> permissoes) {
    ...
    private TokenDTO criarTokenDTO(UUID uuid, String username) {
        return new TokenDTO(uuid, username, true,
                new Date(), new Date(System.currentTimeMillis() + HORA_EM_MILISSEGUNDO),
    ...
    class Entrar {
        ...
        void entrarComCredenciaisValidas() {
            ...
            Usuario usuarioEntity = criarUsuario(usuarioUuid, "usuarioValido", "senhaCodificada", permissoes);
            TokenDTO tokenDTOEsperado = criarTokenDTO(usuarioUuid, "usuarioValido");
        ...
        void entrarComUsuarioSemPermissoes() {
            ...
            Usuario usuarioEntity = criarUsuario(usuarioUuid, "usuarioSemPermissoes", "senhaCodificada", Collections.emptyList());
            TokenDTO tokenDTOEsperado = criarTokenDTO(usuarioUuid, "usuarioSemPermissoes");
        ...
        void entrarComUsuarioComMultiplasPermissoes() {
            ...
            Usuario usuarioEntity = criarUsuario(usuarioUuid, "usuarioAdmin", "senhaCodificada", permissoes);
            TokenDTO tokenDTOEsperado = criarTokenDTO(usuarioUuid, "usuarioAdmin");
        ...
        void entrarComSenhaInvalida() {
            ...
            Usuario usuarioEntity = criarUsuario(usuarioUuid, "usuarioValido", "senhaCodificada", null);
        ...
        void entrarComErroNoJwtProvider() {
            UUID usuarioUuid = UUID.randomUUID();
            LoginDTO loginDTO = new LoginDTO("usuarioValido", "senhaCorreta");
            Usuario usuarioEntity = criarUsuario(usuarioUuid, "usuarioValido", "senhaCodificada", Collections.emptyList());
        ...
        void entrarComPermissoesNulas() {
            ...
            Usuario usuarioEntity = criarUsuario(usuarioUuid, "usuarioComPermissoesNulas", "senhaCodificada", null);
            TokenDTO tokenDTOEsperado = criarTokenDTO(usuarioUuid, "usuarioComPermissoesNulas");
    ...
    class RefreshToken {
        ...
        void refreshTokenComSucesso() {
            ...
            TokenDTO tokenDTOEsperado = criarTokenDTO(usuarioEntity.getUuid(), usuario);
